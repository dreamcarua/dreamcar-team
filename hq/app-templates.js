...
(function () {
  ...
  (function () {
    ...
    css.textContent =
      ...
      '.hq-tpl-modal { position: fixed; inset: 0; background: rgba(0,0,0,0.7); backdrop-filter: blur(4px); z-index: 300; display: flex; align-items: center; justify-content: center; padding: 20px; }' +
