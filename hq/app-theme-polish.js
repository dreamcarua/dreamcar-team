/* ============================================================
   ...
   ============================================================ */
// Брендбук DreamCar:
//   • Червоний: #E30613 (primary)
//   • Помаранчевий: #FF1A2B (accent)
//   • Темний bg: #0a0a0e / #141414 (motorsport mood)
//   • Брендовий градієнт: 135deg, #E30613 → #FF1A2B
//
  ...
  function inject() {
    ...
    css.textContent =
      ...
      'body:not(.hq-light) .view-header h1 {' +
        'background: linear-gradient(90deg, #fff 30%, #FF1A2B 100%);' +
      ...
      'body:not(.hq-light) .sidebar a.nav-item.active {' +
        ...
        'border-left: 3px solid #FF1A2B !important;' +
        'color: #fff !important;' +
      '}' +
      ...
      'body:not(.hq-light) .btn-primary, body:not(.hq-light) .pf-btn.on, body:not(.hq-light) .btn-segmented.on {' +
        'background: linear-gradient(135deg, #E30613 0%, #FF1A2B 100%) !important;' +
        'color: #fff !important;' +
      ...
      'body:not(.hq-light) .cal-day.today .day-num {' +
        'background: linear-gradient(135deg, #E30613, #FF1A2B) !important;' +
      ...
      'body.hq-light .topbar .bell:hover, body.hq-light .hq-topbar-icon:hover {' +
        'background: rgba(216,0,4,0.06) !important; color: #E30613 !important; border-color: #E30613 !important;' +
      '}' +
      ...
      'body.hq-light .sidebar a.nav-item.active {' +
        ...
        'border-left: 3px solid #E30613 !important; color: #E30613 !important;' +
      '}' +
      ...
      'body.hq-light .sidebar a.nav-item.active .count {' +
        'background: linear-gradient(135deg, #E30613, #FF1A2B) !important; color: #fff !important;' +
      '}' +
      ...
      'body.hq-light .sidebar .filter-chip.on { color: #E30613 !important; background: rgba(216,0,4,0.08) !important; }' +
      ...
      'body.hq-light .cal-nav button:hover {' +
        'background: #f0f0f5 !important; border-color: #E30613 !important; color: #E30613 !important;' +
      '}' +
      ...
      'body.hq-light .cal-day .more:hover { color: #E30613 !important; }' +
      ...
      'body.hq-light .week-col .col-head.today { color: #E30613 !important; }' +
      ...
      'body.hq-light .board-col.urgent .col-head .cnt { background: linear-gradient(135deg, #E30613, #FF1A2B) !important; color: #fff !important; }' +
      ...
      'body.hq-light .modal-head .close:hover { background: #f0f0f5 !important; color: #E30613 !important; border-color: #E30613 !important; }' +
      ...
      'body.hq-light .chip.on {' +
        ...
        'border-color: #E30613 !important; color: #E30613 !important; font-weight: 700;' +
      '}' +
      ...
      'body.hq-light .btn-danger { background: #ffffff !important; color: #E30613 !important; border: 1px solid #E30613 !important; }' +
      ...
      'body.hq-light .status.review {' +
        ...
        'color: #E30613 !important; border: 1px solid #FF1A2B;' +
      '}' +
      ...
      'body.hq-light .preview-card .pv-text .pv-hash { color: #E30613 !important; }' +
      ...
      'body.hq-light .creative-strip .cs-add:hover { border-color: #E30613 !important; color: #E30613 !important; }' +
      ...
      'body.hq-light .hq-onb-step .desc a { color: #E30613 !important; }' +
      'body.hq-light .hq-onb-step .desc code { background: #ebebee !important; color: #E30613 !important; }' +
      'body.hq-light .hq-onb-step.done { background: rgba(74,222,128,0.04) !important; border-color: #4ade80 !important; }' +
      'body.hq-light .hq-onb-summary .pct { color: #E30613 !important; }' +
      ...
      'body.hq-light .tab.active { color: #E30613 !important; border-bottom-color: #E30613 !important; }' +
      ...
      'body.hq-light .dropdown-item:hover { background: #f0f0f5 !important; color: #E30613 !important; }' +
      ...
      'body.hq-light .bulk-bar { background: #ffffff !important; border: 1px solid #E30613 !important; box-shadow: 0 -4px 20px rgba(0,0,0,0.08) !important; }' +
